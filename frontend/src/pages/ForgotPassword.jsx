          ...
          <div className="relative z-10">
            <div className="text-center mb-4 sm:mb-6">
              <motion.div
                ...
                className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 text-white shadow-xl shadow-orange-500/30 relative"
              >
              ...
              >
                <Sparkles size={14} className="sm:w-4 sm:h-4 text-amber-500" />
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="relative">
                        <Mail
                          className={`absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 transition-colors ${focusedField === "email" ? "text-amber-500" : isDark ? "text-gray-500" : "text-gray-400"}`}
                          size={16}
                        />
                        <input
                          type="email"
                          ...
                          className={`w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-3.5 text-sm sm:text-base rounded-xl transition-all ${isDark ? "bg-white/5 border-white/10 text-white placeholder-gray-500 focus:border-amber-500/50 focus:bg-white/10" : "bg-white border-gray-200 text-black placeholder-gray-400 focus:border-amber-500/50"} border focus:outline-none focus:ring-2 focus:ring-amber-500/20`}
